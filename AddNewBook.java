...
public class AddNewBook extends javax.swing.JFrame {
    ...
    private void c3ActionPerformed(java.awt.event.ActionEvent evt) {                                   
        ...
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("12");c4.addItem("11");c4.addItem("10");
        }
    ...
    public void connect()
    {
        ...
        {  
            ...
            con=DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/mysql?zeroDateTimeBehavior=CONVERT_TO_NULL [root on Default schema]","root",""); 
